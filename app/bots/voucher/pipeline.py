...
def run_v2_voucher(
    ...
    if not decision.execute:
        ...
        result = execute_voucher_entry(plan, test_mode=test_mode, page=page)
...
def run_v2_voucher_dir(
    ...
    special_prompts = special_vendor_prompts or load_special_vendor_prompts()
    runid = runid or generate_runid("voucher_v2", test_mode=test_mode, bot_name="voucher_v2_pipeline", context={"directory": str(directory)})
...
if __name__ == "__main__":
    ...
    test_invoice = './data/vestis.pdf'
    result = run_v2_voucher(test_invoice, page=None, test_mode=True)
    pprint(result)
